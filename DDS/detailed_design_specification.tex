...
\newcommand{\docname}{Details Design Specification}
...
\begin{figure}[h!]
	\centering
   	\includegraphics[width=0.60\textwidth]{images/MavDegreePlannerDiagram} % Change to correct image file
\end{figure}
\vspace{0.5 in}
...
\begin{versionhistory}
  	\vhEntry{0.1}{02.24.2022}{DN}{document creation}
  	\vhEntry{0.2}{02.24.2022}{DN, IU, SU, LN}{document draft}
  	\vhEntry{0.3}{03.08.2022}{DN, IU, SU, LN}{document update}
  	\vhEntry{0.4}{03.09.2022}{DN, IU, SU, LN}{document complete}
  	\vhEntry{0.5}{05.07.2022}{DN, IU, SU, LN}{document revision}
\end{versionhistory}
\newpage
